                                ...
                                <form action="/search" method="get">
                                    <div class="input-field col s12">
                                        ...
                                        <div class="col l8 m12">
                                            ...
                                            <input type="search" minlength="4" name="search" class="white validate autocomplete_product  grey-text input-search" required="" aria-required="true" >
                                        </div>
                                     </div>
                                    <div class="input-field col  s4 white input-search" style="margin-left: 20px">
                                        <select name="gender">
                                            <option value="male">male</option>
                                            <option value="female">female</option>
                                        </select>
                                        <label class="white-text" style="margin-top: -10px">gender</label>
                                    </div>
                                    <div class="input-field col s4 offset-s3 white input-search" style="margin-left: 24%">
                                        <select name="typeCloth" style="border-bottom: none">
                                            @foreach($categories as $category)
                                                @if (strcasecmp($category->name, "male") && strcasecmp($category->name, "female"))
                                                    <option value="{{$category->name}}">{{$category->name}}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        <label class="white-text" style="margin-top: -10px;">Category</label>
                                    </div>
                                </form>
                            </div>
                        </div>
